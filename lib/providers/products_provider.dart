...
import 'package:statemanage/models/http_exception.dart';
...
class Products with ChangeNotifier {
  ...
  Future<void> fatchAndSetProducts() async {
    const url =
        'https://statemanagement-academind.firebaseio.com/products.json';
    try {
  ...
  Future<void> deleteProduct(String id) async {
    ...
    if (response.statusCode >= 400) {
      ...
      notifyListeners();
      throw HttpExcepetion("Could not delete product");
    }
